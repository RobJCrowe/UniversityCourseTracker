...
namespace Xamarin_Crowe_Robert.Courses
{
    ...
    public partial class EDIT_OaAssessmentPage : ContentPage
    {
        private EDITCourseVM mcvm;
        private bool isUpdate;
        public EDIT_OaAssessmentPage()
        {
            InitializeComponent();
        }

        public EDIT_OaAssessmentPage(EDITCourseVM MCVM, string title)
        {
            InitializeComponent();
        ...
        public EDIT_OaAssessmentPage(EDITCourseVM MCVM, string title, bool IsUpdate)
        {
            InitializeComponent();
            oaTitleLabel.Text = title;
            isUpdate = IsUpdate;
        ...
        private bool isValid(string testType)
        {
            ...
            void invalidAlertMessage(int index)
            {
                switch (index)
                {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        DisplayAlert("Warning", "You must still save the course for changes to take effect.", "Okay");
                        break;
                }
            }
            ...
            private void SaveAssessment_Clicked(object sender, EventArgs e)
            {
                ...
                MessagingCenter.Send<Courses.EDIT_OaAssessmentPage, EDITCourseVM>(this, "Updated_Mcvm", mcvm);
                invalidAlertMessage(6);
                Navigation.PopAsync();
