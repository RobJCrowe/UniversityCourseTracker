...
namespace Xamarin_Crowe_Robert.Courses
{
	...
	public partial class EDIT_PaAssessment : ContentPage
	{
        private EDITCourseVM mcvm;
        private bool isUpdate;
        public EDIT_PaAssessment()
        {
            InitializeComponent();
        }

        public EDIT_PaAssessment(EDITCourseVM MCVM, string title)
        {
            InitializeComponent();
        ...
        public EDIT_PaAssessment(EDITCourseVM MCVM, string title, bool IsUpdate)
        {
            InitializeComponent();
            paTitleLabel.Text = title;
            isUpdate = IsUpdate;
        ...
        private void SaveAssessment_Clicked(object sender, EventArgs e)
        {
            ...
            MessagingCenter.Send<Courses.EDIT_PaAssessment, EDITCourseVM>(this, "Updated_Mcvm_Pa", mcvm);
            Navigation.PopAsync();
